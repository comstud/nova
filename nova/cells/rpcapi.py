...
class CellsAPI(rpc_proxy.RpcProxy):
    ...
    def schedule_run_instance(self, ctxt, **kwargs):
        ...
        self.cast(ctxt, self.make_msg('schedule_run_instance', **kwargs))
    ...
    def get_cell_info_for_siblings(self, ctxt):
        """Get our list of cells and their information from the manager."""
        if not CONF.cells.enable:
            return []
